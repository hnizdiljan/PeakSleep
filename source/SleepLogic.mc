...
// Odstraněno - Historical Stats konstanty kvůli zjednodušení

// Odstraněno - Daily Stats funkce kvůli Garmin SDK bug

module SleepLogic {

    // Odstraněno - SleepPattern typedef kvůli zjednodušení

    // Odstraněno - DailyStat typedef kvůli Garmin SDK bug
    ...
    // =============== HISTORICAL ANALYSIS FUNKCE ODSTRANĚNY ===============
    // Kvůli zjednodušení aplikace - používá se jen základní recharge rate

    // =============== ENHANCED RECHARGE RATE FUNKCE ODSTRANĚNY ===============
    // Kvůli zjednodušení aplikace - používá se jen základní recharge rate

    // =============== DAILY STATS FUNKCE ODSTRANĚNY ===============
    // Kvůli známému Garmin SDK bugu s getBodyBatteryHistory() Out of Memory chybou
